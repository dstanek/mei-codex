...
This is an Obsidian personal knowledge management (PKM) vault called "Mei Codex". It is not a software project — there are no build systems, tests, or deployments. The "code" here is Markdown notes, Templater scripts, and Dataview queries.
