...
See [CLAUDE.md](CLAUDE.md) for folder structure and repo-specific guidance, and `99 Meta/Conventions.md` for note types, project conventions, domains, and GTD rules.
