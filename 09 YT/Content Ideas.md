...
Every content idea lives as its own note in `09 YT/Ideas/`, flat. Create one with the **Content Idea** template — it prompts for a title, content type, and source link, then files itself.
